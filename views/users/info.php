	...
	<div class="row" style="margin: 0!important">
		...
		<div class="col-md-6" style="margin-bottom: 20px" id="info-user">
			...
			<div class="form-group">
				<label for="">Tên</label>
				<input class="form-control" type="text" value="<?php echo $_SESSION['user']['name'] ?>" id="name">
			</div>
			<div class="form-group">
				<label for="">Địa chỉ</label>
				<input class="form-control" type="text" value="<?php echo $_SESSION['user']['addr'] ?>" id="addr">
			</div>
			<div class="form-group">
				<label for="">Số điện thoại</label>
				<input class="form-control" type="text" value="<?php echo $_SESSION['user']['phone'] ?>" id="tel">
			</div>
			<div class="form-group">
