...
<body>
	<header id='header'>
		...
		<ul class="header-menu">
			...
			<?php } else { ?>
				<li><a onclick="$('#user-setting').toggle()" id="s-s">Chào <?php echo $_SESSION['user']['username'] ?></a>
					<div class='mn-ef'></div>
				</li>
				<div id='user-setting'>
					<ul>
		...
		<div class="header-detail">
			<p>Hoàng Văn Thụ Project Mini<br>
				<i>8h - 22h Hằng ngày</i>
			</p>
		</div>
	</header>
	...
	<nav class="navbar navbar-default" role="navigation" id="nav">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand logo" href="">Mua đồng hồ đê</a>
	...
	<footer>
		<div class="container-fluid my-4">
			<div class="row">
				<div class="col-6 text-center mx-auto my-5">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.191503864851!2d106.66039657589857!3d10.796640058818786!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752932200857cf%3A0xc6b65d6821b957ef!2zNDggTmfDtCBUaOG7iyBUaHUgTWluaCwgUGjGsOG7nW5nIDMsIFTDom4gQsOsbmgsIFRow6BuaCBwaOG7kSBI4buTIENow60gTWluaCwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1669906164600!5m2!1svi!2s" width="300" height="300" frameborder="0" style="border:0" allowfullscreen id="maps"></iframe>
				</div>
